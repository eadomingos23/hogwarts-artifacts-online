...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a3.setDescription("The Elder Wand, known throughout history as the Deathstick or the Wand...");
        ...
        a5.setDescription("A goblin-made sword adorned with large rubies on the pommel. It was...");
    ...
    void testFindArtifactByIDSuccess() throws Exception {
        ...
        this.mockMvc.perform(get("/api/v1/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.code").value(SatusCode.SUCCESS))
    ...
    @Test
    void testFindArtifactsSuccess() throws Exception {
        //Given
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto(null,
                "Remembrall",
                "A Remembrall was a magical large marble-sized glass ball that" +
                        " contained smoke which turned red when its owner or user" +
                        " had forgotten something.It turned clear once " +
                        "whatever was forgotten was remembered",
                "ImageUrl",
                null);
        ...
        savedArtifact.setDescription("A Remembrall was a magical large marble-sized glass ball that" +
                " contained smoke which turned red when its owner or user" +
                " had forgotten something. It turned clear once " +
                "whatever was forgotten was remembered");
...
// Given
        ...
        given(this.artifactService.update(
                eq("1250808601744904192"),
                Mockito.any(Artifact.class)
